...
impl StructureType {
    ...
    pub const REMOTING_REMOTE_CONTEXT_PROPERTIES_MSFT: StructureType = Self(1000064000i32);
    pub const REMOTING_CONNECT_INFO_MSFT: StructureType = Self(1000064001i32);
