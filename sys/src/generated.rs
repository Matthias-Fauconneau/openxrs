...
impl StructureType {
    ...
    pub const REMOTING_REMOTE_CONTEXT_PROPERTIES_MSFT: StructureType = Self(1000065000i32);
    pub const REMOTING_CONNECT_INFO_MSFT: StructureType = Self(1000065001i32);
...
impl fmt::Debug for StructureType {
    fn fmt(&self, fmt: &mut fmt::Formatter) -> fmt::Result {
        let name = match *self {
            ...
            Self::REMOTING_REMOTE_CONTEXT_PROPERTIES_MSFT => {
                Some("REMOTING_REMOTE_CONTEXT_PROPERTIES_MSFT")
            }
            Self::REMOTING_CONNECT_INFO_MSFT => Some("REMOTING_CONNECT_INFO_MSFT"),
...
#[repr(C)]
#[derive(Copy, Clone, Debug)]
#[doc = "See [XrRemotingConnectInfoMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrRemotingConnectInfoMSFT) - defined by [XR_MSFT_holographic_remoting](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_holographic_remoting)"]
pub struct RemotingConnectInfoMSFT {
    pub ty: StructureType,
    pub next: *const c_void,
    pub remote_host_name: *const c_char,
    pub remote_port: u16,
    pub secure_connection: Bool32,
}
impl RemotingConnectInfoMSFT {
    pub const TYPE: StructureType = StructureType::REMOTING_CONNECT_INFO_MSFT;
}
#[repr(C)]
#[derive(Copy, Clone, Debug)]
...
pub mod pfn {
    ...
    #[doc = "See [xrRemotingConnectMSFT](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#xrRemotingConnectMSFT) - defined by [XR_MSFT_holographic_remoting](https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_holographic_remoting)"]
    pub type RemotingConnectMSFT = unsafe extern "system" fn(
        instance: Instance,
        system_id: SystemId,
        connect_info: *const RemotingConnectInfoMSFT,
    ) -> Result;
...
pub const MSFT_holographic_remoting_SPEC_VERSION: u32 = 1u32;
pub const MSFT_HOLOGRAPHIC_REMOTING_EXTENSION_NAME: &[u8] = b"XR_MSFT_holographic_remoting\0";
