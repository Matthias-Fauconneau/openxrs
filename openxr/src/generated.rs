...
pub struct ExtensionSet {
    ...
    pub msft_holographic_remoting: bool,
...
impl ExtensionSet {
    pub(crate) fn from_properties(properties: &[sys::ExtensionProperties]) -> Self {
        ...
        for ext in properties {
            match crate::fixed_str_bytes(&ext.extension_name) {
                ...
                raw::HolographicRemotingMSFT::NAME => {
                    out.msft_holographic_remoting = true;
                }
    ...
    pub(crate) fn names(&self) -> Vec<Cow<'static, [u8]>> {
        ...
        {
            if self.msft_holographic_remoting {
                out.push(raw::HolographicRemotingMSFT::NAME.into());
            }
        }
        {
...
pub struct InstanceExtensions {
    ...
    pub msft_holographic_remoting: Option<raw::HolographicRemotingMSFT>,
...
impl InstanceExtensions {
    ...
    pub unsafe fn load(
        ...
        Ok(Self {
            ...
            msft_holographic_remoting: if required.msft_holographic_remoting {
                Some(raw::HolographicRemotingMSFT::load(entry, instance)?)
            } else {
                None
            },
...
pub mod raw {
    ...
    #[derive(Copy, Clone)]
    pub struct HolographicRemotingMSFT {
        pub remoting_connect: pfn::RemotingConnectMSFT,
    }
    impl HolographicRemotingMSFT {
        pub const VERSION: u32 = sys::MSFT_holographic_remoting_SPEC_VERSION;
        pub const NAME: &'static [u8] = sys::MSFT_HOLOGRAPHIC_REMOTING_EXTENSION_NAME;
        #[doc = r" Load the extension's function pointer table"]
        #[doc = r""]
        #[doc = r" # Safety"]
        #[doc = r""]
        ...
        pub unsafe fn load(entry: &Entry, instance: sys::Instance) -> Result<Self> {
            Ok(Self {
                remoting_connect: mem::transmute(entry.get_instance_proc_addr(
                    instance,
                    CStr::from_bytes_with_nul_unchecked(b"xrRemotingConnectMSFT\0"),
                )?),
            })
        }
    }
